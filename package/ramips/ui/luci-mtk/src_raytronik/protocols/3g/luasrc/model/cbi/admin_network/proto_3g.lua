...
service:value("lte_cmcc", "4G/LTE(MTN-Irancell)")
service:value("lte_cmcc", "4G/TD-LTE(MTN-Irancell)")
service:value("lte_cucc", "4G/LTE(MCI-Hamrah Aval)")
service:value("lte_ctcc", "4G/LTE(Rightel)")
service:value("lte_ctcc", "4G/TD LTE(MobinNet)")
